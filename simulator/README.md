...
环境输入面板支持普通/测重压力板、阳光探测器、避雷针、讲台和标靶。炼药锅、蜂箱、重生锚等支持方块状态的比较器读数，具体边界见 [环境输入](docs/environmentInputs.md)。工程菜单提供“活塞实验”和“环境实验”样例。普通箱、陷阱箱、木桶已支持库存编辑与双箱联动；漏斗已支持容器之间的传输与锁定，提供“漏斗实验”；掉落物吸入、加工等仍在开发。原版状态表的覆盖范围大于实际仿真覆盖范围。
